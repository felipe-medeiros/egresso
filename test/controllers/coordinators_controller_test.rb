...
class CoordinatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coordinator" do
    assert_difference('Coordinator.count') do
      post coordinators_url, params: { coordinator: { course_id: @coordinator.course_id, matricula: @coordinator.matricula, nome: @coordinator.nome } }
    end
  ...
  test "should update coordinator" do
    patch coordinator_url(@coordinator), params: { coordinator: { course_id: @coordinator.course_id, matricula: @coordinator.matricula, nome: @coordinator.nome } }
